...
{
    public class UpdateRolePermissionCommandHandlerTests
    {
        private readonly Mock<IUnitOfWork> _unitOfWorkMock;
        private readonly Mock<ICacheInvalidationService> _cacheInvalidationServiceMock;
        private readonly UpdateRolePermissionCommandHandler _handler;
        private readonly UpdateRolePermissionCommand _request;

        public UpdateRolePermissionCommandHandlerTests()
        {
            _unitOfWorkMock = new Mock<IUnitOfWork>();
            _cacheInvalidationServiceMock = new Mock<ICacheInvalidationService>();
            _handler = new UpdateRolePermissionCommandHandler(_unitOfWorkMock.Object, _cacheInvalidationServiceMock.Object);

            _request = new UpdateRolePermissionCommand
            {
                RoleId = Guid.NewGuid(),
